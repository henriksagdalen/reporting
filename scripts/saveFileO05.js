function saveToFileO05() {
    const oscar05form = document.getElementById("oscar05form");
    if (oscar05form.checkValidity()) {
    ...
    var status = document.getElementById("status0").value;
    var enemyPosition = document.getElementById("enemyposition0").value;
    var actionSinceLast = document.getElementById("actionsincelast0").value;
    var ownPlan = document.getElementById("ownplan0").value;
    ...
    var fileContent = "Classification: " + classification + "\n\n"
        ...
        + "Actions since last SITREP: " + actionSinceLast + "\n"
        + "Own plan of action: " + ownPlan + "\n"
